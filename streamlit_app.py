...
ticker_to_arabic_name = {
    ...
    '4050.SR' : 'الشركة السعودية لخدمات السيارات والمعدات',
    '4051.SR' : 'شركة باعظيم التجارية',
    '4061.SR' : 'مجموعة أنعام الدولية القابضة',
    '4070.SR' : 'شركة تهامة للإعلان والعلاقات العامة',
    '4071.SR' : 'الشركة العربية للتعهدات الفنية',
    '4072.SR' : 'شركة مجموعة إم بي سي',
    '4080.SR' : 'شركة سناد القابضة',
    '4081.SR' : 'شركة النايفات للتمويل',
    '4082.SR' : 'شركة المرابحة المرنة للتمويل',
    '4090.SR' : 'شركة طيبة للإستثمار',
    '4100.SR' : 'شركة مكة للإنشاء والتعمير',
    '4110.SR' : 'شركة باتك للإستثمار والأعمال اللوجستية',
    '4130.SR' : 'شركة الباحة للإستثمار والتنمية',
    '4140.SR' : 'الشركة السعودية للصادرات الصناعية',
    '4141.SR' : 'شركة العمران للصناعة والتجارة',
    '4142.SR' : 'شركة مجموعة كابلات الرياض',
    '4143.SR' : 'شركة مجموعة التيسير تالكو الصناعية',
    '4150.SR' : 'شركة الرياض للتعمير',
    '4160.SR' : 'شركة ثمار التنمية القابضة',
    '4161.SR' : 'شركة بن داود القابضة',
    '4162.SR' : 'شركة المنجم للأغذية',
    '4163.SR' : 'شركة الدواء للخدمات الطبية',
    '4164.SR' : 'شركة النهدي الطبية',
    '4165.SR' : 'شركة الماجد للعود',
    '4170.SR' : 'شركة المشروعات السياحية',
    '4180.SR' : 'مجموعة فتيحي القابضة',
    '4190.SR' : 'شركة جرير للتسويق',
    '4191.SR' : 'شركة عبد الله سعد محمد أبو معطي للمكتبات',
    '4192.SR' : 'شركة متاجر السيف للتنمية والاستثمار',
    '4200.SR' : 'شركة الدريس للخدمات البترولية و النقليات',
    '4210.SR' : 'المجموعة السعودية للأبحاث والإعلام',
    '4220.SR' : 'إعمار المدينة الإقتصادية',
    '4230.SR' : 'شركة البحر الأحمر العالمية',
    '4240.SR' : 'شركة فواز عبدالعزيز الحكير وشركاه',
    '4250.SR' : 'شركة جبل عمر للتطوير',
    '4260.SR' : 'الشركة المتحدة الدولية للمواصلات',
    '4261.SR' : 'شركة ذيب لتأجير السيارات',
    '4262.SR' : 'شركة لومي للتأجير',
    '4263.SR' : 'شركة سال السعودية للخدمات اللوجستية',
    '4270.SR' : 'الشركة السعودية للطباعة والتغليف',
    '4280.SR' : 'شركة المملكة القابضة',
    '4290.SR' : 'شركة الخليج للتدريب والتعليم',
    '4291.SR' : 'الشركة الوطنية للتربية و التعليم',
    '4292.SR' : 'شركة عطاء التعليمية',
    '4300.SR' : 'شركة دار الأركان للتطوير العقاري',
    '4310.SR' : 'مدينة المعرفة الإقتصادية',
    '4320.SR' : 'شركة الأندلس العقارية',
    '4321.SR' : 'شركة المراكز العربية',
    '4322.SR' : 'شركة رتال للتطوير العمراني',
    '4323.SR' : 'شركة سمو العقارية',
    '4330.SR' : 'صندوق الرياض ريت',
    '4331.SR' : 'صندوق الجزيرة ريت',
    '4332.SR' : 'صندوق جدوى ريت الحرمين',
    '4333.SR' : 'صندوق تعليم ريت',
    '4334.SR' : 'صندوق المعذر ريت',
    '4335.SR' : 'صندوق مشاركة ريت',
    '4336.SR' : 'صندوق ملكية عقارات الخليج ريت',
    '4337.SR' : 'صندوق سيكو السعودية ريت',
    '4338.SR' : 'صندوق الأهلي ريت 1',
    '4339.SR' : 'صندوق دراية ريت',
    '4340.SR' : 'صندوق الراجحي ريت',
    '4342.SR' : 'صندوق جدوى ريت السعودية',
    '4344.SR' : 'صندوق سدكو كابيتال ريت',
    '4345.SR' : 'صندوق الإنماء ريت لقطاع التجزئة',
    '4346.SR' : 'صندوق ميفك ريت',
    '4347.SR' : 'صندوق بنيان ريت',
    '4348.SR' : 'صندوق الخبير ريت',
    '4349.SR' : 'صندوق الإنماء ريت الفندقي',
    '4350.SR' : 'صندوق الإستثمار اريك ريت المتنوع',
...
default_tickers = ', '.join([
    ...
    '4350.SR', '5110.SR', '6001.SR', '6002.SR', '6004.SR', '6010.SR', 
    '6012.SR', '6013.SR', '6014.SR', '6015.SR', '6020.SR', '6040.SR', 
    '6050.SR', '6060.SR', '6070.SR', '6090.SR', '7010.SR', '7020.SR', 
    '7030.SR', '7040.SR', '7200.SR', '7201.SR', '7202.SR', '7203.SR', 
    '7204.SR', '8010.SR', '8012.SR', '8020.SR', '8030.SR', '8040.SR', 
    '8050.SR', '8060.SR', '8070.SR', '8100.SR', '8120.SR', '8150.SR', 
    '8160.SR', '8170.SR', '8180.SR', '8190.SR', '8200.SR', '8210.SR', 
    '8230.SR', '8240.SR', '8250.SR', '8260.SR', '8270.SR', '8280.SR', 
    '8300.SR', '8310.SR', '8311.SR'
])
