    ...
    for ticker in tickers:
        ...
        if lowest_price <= current_price <= lowest_price * multiplier:
            results[ticker] = {
                ...
                'lowest_52_week_price': lowest_price
            }
...
tickers_input = st.text_area("Enter stock tickers (comma-separated)", 
                              value='1010.SR', '1020.SR', '1030.SR', '1050.SR', '1060.SR', '1080.SR', '1111.SR', '1120.SR',
...
if st.button("Check Prices"):
    ...
    if result:
        ...
        for ticker, data in result.items():
            st.write(f"{ticker}: Current Price = {data['current_price']}, "
                      f"Lowest 52-week Price = {data['lowest_52_week_price']}")
    else:
